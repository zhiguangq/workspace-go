...
func (this *ManageDepartmentController) Get() {
	...
	this.TplName = "camera/camera.tpl"
}
...
func (this *AddDepartmentController) Get() {
	this.TplName = "camera/camera-form.tpl"
}
...
func (this *AddDepartmentController) Post() {
	...
	dep.Playurl = "http://" + beego.AppConfig.String("hlsServer") + ":" + beego.AppConfig.String("httpport") + "/hls/" + dep.Dns + "_" + dep.Channel + "_" + fmt.Sprintf("%d", dep.Id) + ".m3u8"
	err := AddDeparts(dep)
...
func (this *EditDepartmentController) Post() {
	...
	dep.Address1 = address1
	dep.Address2 = address2
	dep.Playurl = "http://" + beego.AppConfig.String("hlsServer") + ":" + beego.AppConfig.String("httpport") + "/hls/" + dep.Dns + "_" + dep.Channel + "_" + fmt.Sprintf("%d", id) + ".m3u8"
